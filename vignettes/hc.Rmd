...
# following code.
# sim_flow <- load_swat_run(paste0(model_path, '/',  paste0(save_file_name, '_q')))
```
...
## 6. Calculating performance metrics {#hc_step6}
...
calculate_performance_multi <- function(sim, vector_var, list_obs, list_periods = NULL, 
                                        vector_weights = 1, 
